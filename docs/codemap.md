...
| Text / dialogue | **DRAWN ON SCREEN** — 1906 strings in en and ja, rendered in the game's own `BasicFont.sfont` with word wrap. English only: the font is ASCII 32..126 and CJK comes from the Android system font | `tools/asset/strings.py`, `src/mcf/assets.cpp`, `src/host/main.cpp` |
